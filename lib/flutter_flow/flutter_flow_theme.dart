...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF02327D);
  late Color secondary = const Color(0xFF03409F);
  late Color tertiary = const Color(0xFF000000);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF02327D);
  late Color secondaryText = const Color(0xFF03409F);
  late Color primaryBackground = const Color(0xFFE3F2FD);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFF3FC2E4);
