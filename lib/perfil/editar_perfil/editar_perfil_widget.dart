  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarisRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarisRow> editarPerfilUsuarisRowList = snapshot.data!;
        final editarPerfilUsuarisRow = editarPerfilUsuarisRowList.isNotEmpty
            ? editarPerfilUsuarisRowList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
              ...
              child: Column(
                ...
                children: [
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.textController1 ??=
                                    ...
                                    text: editarPerfilUsuarisRow?.nom,
                                  ),
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.textController2 ??=
                                      TextEditingController(
                                    text: editarPerfilUsuarisRow?.cognom,
                                  ),
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            controller: _model.textController4 ??=
                                TextEditingController(
                              text: editarPerfilUsuarisRow?.contrasenya,
                            ),
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.usuaris = await UsuarisTable().update(
                          data: {
                            'id': currentUserUid,
                            'nom': _model.textController1.text,
                            'cognom': _model.textController2.text,
                            'url_foto': _model.uploadedFileUrl,
                            'contrasenya': _model.textController5.text,
                          },
